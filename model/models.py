...
def create_conv_model(fingerprint_input, model_settings, is_training):
  ...
  max_poo = tf.nn.max_pool(first_dropout, [1, 2, 2, 1], [1, 2, 2, 1], 'SAME')
  ...
  second_conv = tf.nn.conv2d(max_poo, second_weights, [1, 1, 1, 1],
                             'SAME') + second_bias
  ...
  max_pool = tf.nn.max_pool(second_dropout, [1, 2, 2, 1], [1, 2, 2, 1], 'SAME')
